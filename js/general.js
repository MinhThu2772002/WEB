...
jQuery(window).load(function(){
   ...
   //Set Portfolio Items Height
    ...
    function banner(){
        ...
        if(jQuery('section.intro .slider img').length > 1){
            
            var slider = jQuery('section.intro .slider');
            ...
            slider.carouFredSel({
                ...
                prev : {
                    button          : 'section.intro .sliderHolder .bannerNav a.prev'
                },
                next : {
                    button          : 'section.intro .sliderHolder .bannerNav a.next'
                }, 
                auto : { 
                    play            : true
                },
        ...
        {
            jQuery('section.intro .sliderHolder .bannerNav a').css({'display':'none'});  
        }
    }
	...
	function opinionSlider(){
            ...
            var opinionSlider = jQuery('section.opinion .holder');

            if(opinionSlider.find('article').length > 1){

                opinionSlider.trigger("destroy");

                opinionSlider.find('article').css({'width':'auto', 'height':'auto'});

                var SliderWidth = opinionSlider.find('article').eq(0).width();
                var SliderHeight = opinionSlider.find('article').eq(0).height();

                opinionSlider.find('article').css({'width':SliderWidth, 'height':SliderHeight});

                opinionSlider.carouFredSel({
                        items  : {
                                visible         : 1, 
                                width           : SliderWidth,
                                height          : SliderHeight
                        ...
                        prev : {
                                button          : 'section.opinion .bannerNav a.prev'
                        },
                        next : {
                                button          : 'section.opinion .bannerNav a.next'
                        }, 
                        auto : { 
                                play            : true
                        }
    ...
    opinionSlider();
      ...
      function memberSlider(){
        //Member Slider
        if(jQuery('section.privacy .slider .sliderholder .member').length > 0){
            
            jQuery('section.privacy .slider .sliderholder').trigger("destroy");
            jQuery('section.privacy .slider .sliderholder .member').css({'width':'auto', 'height':'auto'});

            var memberSliderWidth = jQuery('section.privacy .slider .sliderholder .member').eq(0).width();
            var memberSliderHeight = jQuery('section.privacy .slider .sliderholder .member').eq(0).height();

            jQuery('section.privacy .slider .sliderholder .member').css({'width':memberSliderWidth, 'height':memberSliderHeight});

            jQuery('section.privacy .slider .sliderholder').carouFredSel({
              ...
              prev : {
                  button          : 'section.privacy .slider .bannerNav a.prev'
              },
              next : {
                  button          : 'section.privacy .slider .bannerNav a.next'
              }, 
              auto : { 
                  play            : false
              },
